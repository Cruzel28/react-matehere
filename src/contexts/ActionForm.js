...
export const ActionFormProvider = ({ children }) => {
    ...
    const [ infoHavePost, setInfoHavePost ] = useState({ TestInfo1 : undefined,TestInfo2 : undefined})
    const [infoNeedPost, setInfoNeedPost] = useState({ TestInfo : undefined,TestInfo2 : undefined})
